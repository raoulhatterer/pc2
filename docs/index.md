...
!!! note "Version pdf du cours"
    En plus du [cours en ligne](./cours/Chapitre 1.md), une version pdf un peu plus concise est téléchargeable dans les [documents](./documents.md). Veillez à toujours avoir imprimé le chapitre suivant à l'avance ainsi lorsque l'on passera à un nouveau chapitre vous l'aurez à votre disposition.
