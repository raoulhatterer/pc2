# Chapitre VII : Vers des entités plus stables
...
!!! example "{{exercice()}} : configuration électronique"
    === "Énoncé"
        ...
        **Le tableau suivant donne la configuration électronique des 18 premiers éléments chimiques (à l'état fondammental).**   
        ![image](data/chap7_tableau_explique.jpg){: width="800"}
...
!!! example "{{exercice()}} : remplir les sous-couches :heart:"
    ...
    === "Règle de Klechkowski (hors programme)"
        ...
        ![image](data/chap7_Klechkovski_rule.png){: width="200"}
...
![image](data/chap7_tableau_sous_couches.jpg){: .center width="800"}
...
- La configuration électronique d'un atome de silicium de valence est : 3s<sup>2</sup> 3p<sup>2</sup>. Il possède 2 + 2 = 4 électrons de valence.
- La configuration électronique d'un atome d'azote N est 1s<sup>2</sup> 2s<sup>2</sup> 2p<sup>3</sup>, celle d'un atome de phosphore P est : 1s<sup>2</sup> 2s<sup>2</sup> 2p<sup>6</sup> 3s<sup>2</sup> 3p<sup>3</sup>.
...
!!! success "Configuration des gaz nobles"
    ...
    |-----------|----------------------------------------------------------------------------|
    | Hélium    | 1s<sup>2</sup>                                                             |
    | Néon      | 1s<sup>2</sup> 2s<sup>2</sup> 2p<sup>6</sup>                               |
    | Argon     | 1s<sup>2</sup> 2s<sup>2</sup> 2p<sup>6</sup> 3s<sup>2</sup> 3p<sup>6</sup> |


    - La configuration électronique de valence des atomes qui la constituent est de la forme ns<sup>2</sup> np<sup>6</sup> ou, dans le cas de l'hélium, 1s<sup>2</sup>. 
    - Un atome d'hélium possède 2 électrons de valence (duet), un atome de néon et un atome d'argon en possèdent 8 (octet).

!!! success "Règle de stabilité"
...
![image](data/chap7_tableau_ions.jpg){: .center width="400"}

- Un atome d'aluminium perd 3 électrons. L'ion formé Aℓ<sup>3+</sup> a la configuration électronique d'un atome de néon Ne. Le néon est le gaz noble le plus proche.

- Un atome de soufre gagne 2 électrons. L'ion formé S<sup>2-</sup> a la configuration électronique d'un atome d'argon Ar. L'argon est le gaz noble le plus proche.
...
![image](data/chap7_lewis_H2O.jpg){: width="250"}
...
![image](data/chap7_lewis_methanol.jpg){: .center width="600"}
...
![image](data/chap7_lewis_liaisons_multiples.jpg){: .center width="250"}
...
!!! success "Stabilité des liaisons covalentes"
    ...
    - Deux atomes liés par une liaison covalente sont plus stables que les deux atomes isolés. Par exemple, la molécule de dihydrogène H<sub>2</sub> est plus stable énergétiquement que les deux atomes isolés H.
    ![image](data/chap7_energie_liaison.jpg){: .center width="500"}
    - Plus l'énergie de liaison est grande, plus la liaison est stable.

![image](data/chap7_CH4.jpg){: width="70"}
