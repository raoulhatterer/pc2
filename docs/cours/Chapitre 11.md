...
![image](./data/chap11_descartes.jpg){: .center .img-rounded width="600"}


### 2. Les lois du modèle de la réfraction et de la réflexion

On appelle angle d'incidence i<sub>1</sub> l'angle formé par le rayon incident et la normale au 
...
![image](./data/chap11_arc_en_ciel.jpg){: .center .img-rounded width="500"}

La multiplicité des gouttes nous donne une vision d'ensemble de ce phénomène de dispersion qu'on appelle arc-en-ciel. 

![image](./data/chap11_arc_en_ciel_double.jpg){: .center .img-rounded width="450"}
...
![image](./data/chap11_foyer_objet.jpg){: .center .img-rounded width="300"}
