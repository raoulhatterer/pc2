...
!!! success "Célérité (c-à-d vitesse de propagation de l'onde)"
    ...
    === "Complément d'informations"
        ...
        Des mesures précises montrent que la lumière se propage dans le vide à la vitesse  c = 2,997 924 58 × 10<sup>8</sup> m·s<sup>-1</sup>. Nous retiendrons sa valeur approchée : c ≈ 3,00 × 10<sup>8</sup> m·s<sup>-1</sup>.
...
![image](./data/chap12_temperature.jpg){: .center  width="700"}
...
![image](./data/chap12_metal_fusion.jpg){: .center .img-rounded width="300"}
...
![image](./data/chap12_identifier.jpg){: .center .img-rounded width="800"}
...
![image](./data/chap12_orion2.jpg){: .center  .img-rounded width="300"}
...
!!! info "Le Soleil"
    ...
    ![image](./data/chap12_fraunhofer.svg){: .center .img-rounded width="600"}
